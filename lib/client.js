// dsh-file-upload — Client half (web2 bundle), v2 chip edition.
  ...
  factory: (require) => {
    ...
    function ShellDrop() {
      ...
      if (pendingItems.length > 0) {
        ...
        const card = [
          React.createElement('div', { key: 't', className: 'dsh-dropbox-ready-title' }, '文件已就绪（' + pendingItems.length + ' 个）· v2.0.0'),
